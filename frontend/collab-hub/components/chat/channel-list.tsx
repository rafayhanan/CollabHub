...
export function ChannelList({
  ...
  return (
    <div className="w-full md:w-64 border-b md:border-b-0 md:border-r border-border bg-card flex flex-col h-auto md:h-full min-h-0 overflow-hidden md:overflow-hidden">
      ...
      <ScrollArea
        className="flex-1 min-h-0 p-2 max-h-[40vh] md:max-h-none"
